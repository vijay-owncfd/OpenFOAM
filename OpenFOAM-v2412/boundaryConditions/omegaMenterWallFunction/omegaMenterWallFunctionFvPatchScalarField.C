...
#include "omegaMenterWallFunctionFvPatchScalarField.H"
...
Foam::scalar Foam::omegaMenterWallFunctionFvPatchScalarField::tolerance_ = 1e-5;

// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

void Foam::omegaMenterWallFunctionFvPatchScalarField::setMaster()
{
    if (master_ != -1)
    {
        return;
    ...
    forAll(bf, patchi)
    {
        if (isA<omegaMenterWallFunctionFvPatchScalarField>(bf[patchi]))
        {
            omegaMenterWallFunctionFvPatchScalarField& opf = omegaPatch(patchi);
...
void Foam::omegaMenterWallFunctionFvPatchScalarField::createAveragingWeights()
{
    const auto& omega =
        static_cast<const volScalarField&>(this->internalField());
...
Foam::omegaMenterWallFunctionFvPatchScalarField&
Foam::omegaMenterWallFunctionFvPatchScalarField::omegaPatch
(
    const label patchi
)
{
    ...
    const auto& opf =
        refCast<const omegaMenterWallFunctionFvPatchScalarField>(bf[patchi]);

    return const_cast<omegaMenterWallFunctionFvPatchScalarField&>(opf);
}


void Foam::omegaMenterWallFunctionFvPatchScalarField::calculateTurbulenceFields
(
...
void Foam::omegaMenterWallFunctionFvPatchScalarField::calculate
(
    const turbulenceModel& turbModel,
...
)
{
    ...
    const scalar Cmu5 = sqrt(wallCoeffs_.Cmu());
    ...
    forAll(nutw, facei)
    {
        ...
        const scalar omegaLog = uStar / (Cmu5*kappa*y[facei]);
    
        omega0[celli] += w*sqrt(pow(omegaVis, 2) + pow(omegaLog, 2));
...
void Foam::omegaMenterWallFunctionFvPatchScalarField::writeLocalEntries
(
    Ostream& os
) const
{
...
Foam::omegaMenterWallFunctionFvPatchScalarField::omegaMenterWallFunctionFvPatchScalarField
(
    const fvPatch& p,
...
Foam::omegaMenterWallFunctionFvPatchScalarField::omegaMenterWallFunctionFvPatchScalarField
(
    const omegaMenterWallFunctionFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
Foam::omegaMenterWallFunctionFvPatchScalarField::omegaMenterWallFunctionFvPatchScalarField
(
    const omegaMenterWallFunctionFvPatchScalarField& owfpsf
)
:
...
Foam::scalarField& Foam::omegaMenterWallFunctionFvPatchScalarField::G
(
    bool init
)
{
...
Foam::scalarField& Foam::omegaMenterWallFunctionFvPatchScalarField::omega
(
    bool init
)
{
...
void Foam::omegaMenterWallFunctionFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::omegaMenterWallFunctionFvPatchScalarField::updateWeightedCoeffs
(
...
void Foam::omegaMenterWallFunctionFvPatchScalarField::manipulateMatrix
(
...
void Foam::omegaMenterWallFunctionFvPatchScalarField::write
(
    Ostream& os
) const
{
